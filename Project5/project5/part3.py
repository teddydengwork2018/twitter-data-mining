...
x_new = poly1.fit_transform(fea,t)
xt_new = poly1.fit_transform(fea,t)   
regr.fit(x_new, t)
model = sm.OLS(t, x_new)

print (np.mean((regr.predict(x_new) - t) ** 2))
print (np.mean(abs(regr.predict(x_new) - t)))
print len(hr)
